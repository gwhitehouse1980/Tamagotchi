...
namespace Tamagotchi.Core.Tests
{
    ...
    [TestFixture(30, 30, SatisfactionLevel.VeryGood, SatisfactionLevel.VeryGood)]
    [TestFixture(30, 45, SatisfactionLevel.VeryGood, SatisfactionLevel.VeryGood)]
    [TestFixture(30, 60, SatisfactionLevel.VeryGood, SatisfactionLevel.Good)]
    [TestFixture(30, 75, SatisfactionLevel.VeryGood, SatisfactionLevel.Good)]
    [TestFixture(30, 90, SatisfactionLevel.VeryGood, SatisfactionLevel.Neutral)]
    [TestFixture(30, 105, SatisfactionLevel.VeryGood, SatisfactionLevel.Neutral)]
    [TestFixture(30, 120, SatisfactionLevel.VeryGood, SatisfactionLevel.Bad)]
    [TestFixture(30, 135, SatisfactionLevel.VeryGood, SatisfactionLevel.Bad)]
    [TestFixture(30, 200, SatisfactionLevel.VeryGood, SatisfactionLevel.Bad)]
    public class StatelessSatisfactionServiceIncreaseTests
    {
